...
<html lang="en">
    ...
    <body>
            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h3>We are NOT<br /> an evil bank</h3>
						<h5>We give away free money</h5>
						<a class="org_btn" href="Register.jsp">Create an account</a>
						<a class="green_btn" href="Login.jsp">Log in</a>
					</div>
				</div>
            </div>
        </section>
        <!--================End Home Banner Area =================-->
         ...
         <footer class="footer_title"><a href="Logina.jsp">Administration</a>
         </footer>		
