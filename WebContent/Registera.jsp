				...
				<div class="container">
					<div class="banner_content text-center">
						<div class="page_link">
							...
							<a href="Registera.jsp">Register a customer</a>
						</div>
						<h2>Add a customer to our services</h2>
					</div>
				</div>
            </div>
        </section>
...
<form name="form" action="AdminAddServlet" method="post" onsubmit="return validate()">
<table align="center">
 <tr>
 <td>Full Name</td>
