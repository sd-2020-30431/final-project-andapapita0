					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item"><a class="nav-link" href="Logout.jsp">Log in</a></li>
							</ul>
				...
				<div class="container">
					<div class="banner_content text-center">
						<div class="page_link">
							...
							<a href="DeleteUser.jsp">Login</a>
						</div>
						<h2>Delete customer by entering his/her username below:</h2>
					</div>
				</div>
            </div>
        </section>
...
<br>
<form name="form" action="AdminDeleteServlet" method="post" onsubmit="return validate()">
